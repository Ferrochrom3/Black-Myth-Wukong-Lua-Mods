...
---@class UBI_EquipItem_RZDSlot_C : UBUI_ButtonSpecialNone
...
UBI_EquipItem_RZDSlot_C = {}

---@param IsDesignTime boolean
function UBI_EquipItem_RZDSlot_C:PreConstruct(IsDesignTime) end
function UBI_EquipItem_RZDSlot_C:Construct() end
---@param EntryPoint int32
function UBI_EquipItem_RZDSlot_C:ExecuteUbergraph_BI_EquipItem_RZDSlot(EntryPoint) end
