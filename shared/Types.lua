...
---@return UObject
function StaticConstructObject(Class, Outer, Name, Flags, InternalSetFlags, CopyTransientsFromClassDefaults,
                               AssumeTemplateIsArchetype, Template, InstanceGraph, ExternalPackage, SubobjectOverrides)
end
